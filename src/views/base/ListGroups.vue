    ...
    <CRow>
      <CCol md="6">
        <CCard>
          ...
          <CCardBody>
            <CListGroup>
              <CListGroupItem color="accent-light list-group-item-light">This is a default list group item</CListGroupItem>
              <CListGroupItem color="accent-primary list-group-item-primary">This is a primary list group item</CListGroupItem>
              <CListGroupItem color="accent-secondary list-group-item-secondary">This is a secondary list group item</CListGroupItem>
              <CListGroupItem color="accent-success list-group-item-success">This is a success list group item</CListGroupItem>
              <CListGroupItem color="accent-danger list-group-item-danger">This is a danger list group item</CListGroupItem>
              <CListGroupItem color="accent-warning list-group-item-warning">This is a warning list group item</CListGroupItem>
              <CListGroupItem color="accent-info list-group-item-info">This is a info list group item</CListGroupItem>
              <CListGroupItem color="accent-light list-group-item-light">This is a light list group item</CListGroupItem>
              <CListGroupItem color="accent-dark list-group-item-dark">This is a dark list group item</CListGroupItem>
            </CListGroup>
          </CCardBody>
        </CCard>
      </CCol>
      <CCol md="6">
        <CCard>
          ...
          <CCardBody>
            <CListGroup>
              <CListGroupItem href="#" class="list-group-item-accent-light">This is a default list group item</CListGroupItem>
              <CListGroupItem href="#" class="list-group-item-accent-primary">This is a primary list group item</CListGroupItem>
              <CListGroupItem href="#" class="list-group-item-accent-secondary">This is a secondary list group item</CListGroupItem>
              <CListGroupItem href="#" class="list-group-item-accent-success">This is a success list group item</CListGroupItem>
              <CListGroupItem href="#" class="list-group-item-accent-danger">This is a danger list group item</CListGroupItem>
              <CListGroupItem href="#" class="list-group-item-accent-warning">This is a warning list group item</CListGroupItem>
              <CListGroupItem href="#" class="list-group-item-accent-info">This is a info list group item</CListGroupItem>
              <CListGroupItem href="#" class="list-group-item-accent-light">This is a light list group item</CListGroupItem>
              <CListGroupItem href="#" class="list-group-item-accent-dark">This is a dark list group item</CListGroupItem>
        </CListGroup>
          </CCardBody>
        </CCard>
      </CCol>
